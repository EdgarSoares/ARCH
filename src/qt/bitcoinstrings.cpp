...
"for example: alertnotify=echo %%s | mail -s \"Archcoin Alert\" admin@foo."
"com\n"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Archcoin"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. Archcoin is shutting down."),

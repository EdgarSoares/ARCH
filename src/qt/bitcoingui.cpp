...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(tr("&About Archcoin"), this);
    aboutAction->setToolTip(tr("Show information about Archcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Archcoin"));
...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet(fUseBlackTheme ? "QWidget { background: rgb(2,34,69); }" : "QWidget { background: none; }");
    return spacer;
}
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Archcoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Archcoin address or malformed URI parameters."));
    }
